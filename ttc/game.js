...
function vsPlayer(i) {
    ...
    if (moves === 9) {
        setTimeout(function () {
            alert("Tcihh Masa Sama Bot Seri");
            restartClicked();
        }, 1);
    }
}
...
function vsBotFirst() {
    ...
    if (winCondition(bot)) {
        setTimeout(function () {
            alert("Awowkwowkwok Sama Bot Kalah ");
            restartClicked();
        }, 1);
        return;
    }
    if (moves === 9) {
        setTimeout(function () {
            alert("Ciee Masa Sama Bot Serii");
            restartClicked();
        }, 1);
    }
}
...
function vsBotSecond() {
    ...
    if (winCondition(bot)) {
        setTimeout(function () {
            alert("Awokwowkwowk Sama Bot Kalah");
            restartClicked();
        }, 1);
        return;
    }
...
function playareaClicked(i) {
    "use strict";
    if (level === -1) {
        alert("Pilih Terlebih Dahulu ' Vs Player' Atau 'Vs Bot'");
        return;
    }
    if (occupied[i - 1]) {
        return;
